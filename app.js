...
// wedding date
let weddingDate = new Date(2022, 11, 18, 12);
...
const minutes = `${weddingDate.getMinutes()}`.padStart(2, 0);
...
function getRemainingTime() {
	...
	if (timeDiff === 0) {
		...
		clearInterval(countdown);
		dDay.innerHTML = `<p class="nikkah-day">All praise to Allah, the wedding was successful on the below date</p>`;
	}
}
